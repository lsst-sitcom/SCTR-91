...
\end{tabular}
 Description \\
{\footnotesize
Record the starting position of the actuator in the LabView using the
encoder readings\\[2\baselineskip]

}
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
Displacement graphs in LabView show the starting position of the
actuator.
...
\tightlist
\item
  Set pneumatic valve ~to \textasciitilde{}7V (0-10 Vdc) while the other
  valve remains at 0V.
\item
  increase air supply using LabVIEW function~
\end{itemize}
...
\end{tabular}
 Description \\
{\footnotesize
Observe the end position of the actuator in the LabView using the
encoder readings.\\[2\baselineskip]
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
Displacement graphs in LabView show the end position of the actuator.
...
\end{tabular}
 Description \\
{\footnotesize
Record the current position of the actuator in the LabView using the
encoder readings
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
Displacement graphs in LabView show the current position of the
actuator.
...
Otherwise, \textbf{go to step 14}.~\\[2\baselineskip]
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
Motor drive set to halt position.~
...
\end{tabular}
 Description \\
{\footnotesize
Extend the actuator to its position stroke limit of +14.04mm using the
copley software and control box.

}
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
Actuator extended to its position stroke limit of +14.04mm.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Test Data \\
 {\footnotesize
\textbf{Note:} The extension limit switch is set to 14.06mm so this
should not be hit.~
...
position will need to be adjusted to be greater than 14.06mm and then
the try to extend the actuator to the position stroke limit of +14.04mm.

}
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
Actuator position readjusted and move repeated.~
...
(before it can stop), reposition the limit switch and repeat
test.\\[2\baselineskip]
...
\end{tabular}
 Description \\
{\footnotesize
Repeat the steps 6-12 two more times to assess limit switch position
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
Final positions of the limit switch close to step 8 result(Around
+14.50).
...
\end{tabular}
 Description \\
{\footnotesize
Retract the actuator to its position stroke limit of
-14.04mm.\\[2\baselineskip]
...
\end{tabular}
 Description \\
{\footnotesize
If the limit switch is contacted, readjust its position and repeat move.
...
\end{tabular}
 Description \\
{\footnotesize
Repeat the steps 14-20 two more times to assess limit switch position
repeatability.
...
\end{tabular}
 Description \\
{\footnotesize
Record the actual displacement as measured by the internal encoder as
LabView graph ( Time vs Displacement).
...
\end{tabular}
 Description \\
{\footnotesize
Verify the current probes are measuring the phase currents of the
actuators.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
The current probes are measuring the current of the actuator.~
...
\end{tabular}
 Description \\
{\footnotesize
Using the current, measure the amount of heat being dissipated from the
actuator.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
The two encoders do not contribute more than 2W of heat combined.
