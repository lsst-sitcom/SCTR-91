...
\multicolumn{2}{p{10.9cm}}{\textbf{ Single Hexapod Actuator Redesign Verification }} & In Progress \\\hline
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Vi running and reporting values
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The supply pressure was initially lowered to safely apply force without
overloading the test rig. Therefore, this step was not executed and the
force was applied in increments of 5kN initially.
...
{\footnotesize
The supply pressure was initially lowered to safely apply force without
overloading the test rig. Therefore, this step was not executed.~
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 0.73V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 1.46V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Given 1.46V and the regulator set to 20psi, we observed the following:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 2.19V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 40psi, we set the valve for 2.19V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 2.92V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 40psi, we set the valve for 2.92V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 3.65V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 60psi, we set the valve for 3.65V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 4.38V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 60psi, we set the valve for 4.38V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 5.11V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 70psi, we set the valve for 5.11V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 5.84V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 70psi, we set the valve for 5.84V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 6.57V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 7.30V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 7.3V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 8.03V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 8.50V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 8.17V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 8.65V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 100psi, we set the valve for 8.32V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 8.80V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 8.47V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 8.95V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 8.61V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 9.10V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
Setting the regulator to 90psi, we set the valve for 8.76V:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
No obvious signs of damage and all screws remain tight.
...
force of 60 kN (13,489 lbf) is reached through LabView voltage
regulation VI.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Test Data \\
 {\footnotesize
\textbf{Note:~}In order to apply a tension force of 60kN:

\begin{itemize}
\tightlist
\item
  Set pneumatic valve (closest to hexapod actuator side) to
  \textasciitilde{}7V (0-10 Vdc) while the other valve remains at 0V.
\item
...
voltage in the LabView voltage regulation VI.\\[2\baselineskip]
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Test Data \\
 {\footnotesize
\textbf{Note:~}In order to apply a compression force of 60kN:\\

\begin{itemize}
\tightlist
\item
  Set pneumatic valve (far from the hexapod actuator side) to
  \textasciitilde{}7V (0-10 Vdc) while the other valve remains at 0V (
  reverse from step 6).
\item
  increase air supply using LabVIEW function~
...
\end{tabular}
 Description \\
{\footnotesize
Record the starting position of the actuator motor's rotary encoder
using the copley control software.\\[2\baselineskip]

}
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
Copley records and displays the starting position of the rotary
encoder.~
...
\end{tabular}
 Description \\
{\footnotesize
Slowly apply an increasing {Tension}⁠~ force with the load actuator
until a force of 60 kN (13,489 lbf) is reached through LabView voltage
regulation VI.
...
\tightlist
\item
  Set the closest pneumatic valve ~to \textasciitilde{}7V (0-10 Vdc)
  while the other valve remains at 0V ( Reverse for Compression).
\item
  increase air supply using LabVIEW function~
\end{itemize}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
Load cell reader shows the applied 60 KN {Tension}⁠~ force.\\
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
Load cell reader shows the applied 60 KN {Compression}⁠~ force.\\
LabView displays the voltage being applied.
...
\end{tabular}
 Description \\
{\footnotesize
Record the final position of the actuator motor's rotary encoder using
the copley control software.\\[3\baselineskip]

}
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
Copley records and displays the final position of the rotary encoder.\\
If the motor encoder position has changed significantly
(\textgreater{}10 counts or 0.36 deg of motor rotation), the actuator
has back-driven.
...
\end{tabular}
 Description \\
{\footnotesize
Gradually reduce the {Tension}⁠~ force to obtain zero load.
...
\end{tabular}
 Description \\
{\footnotesize
Gradually reduce the {Compression}⁠~ force to obtain zero load.
...
\end{tabular}
 Description \\
{\footnotesize
Record the current position of the actuator motor's rotary encoder using
the copley control software.
...
\end{tabular}
 Description \\
{\footnotesize
If the actuator has back-driven for 60 kN (2x the max load) tension
force, slowly apply a {Tension}⁠~ force of 37.5 kN (1.25x the max load)
with the the load actuator.\\
Otherwise, \textbf{go to step 15}.~\\[2\baselineskip]

}
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Test Data \\
 {\footnotesize
\textbf{Note:~}In order to apply a {Tension}⁠ ~force of 37.5 kN:

\begin{itemize}
\tightlist
\item
  Set the closest pneumatic valve ~to \textasciitilde{}4.4V (0-10 Vdc)
  while the other valve remains at 0V ( Reverse for Compression).
\item
  increase air supply using LabVIEW function~
\end{itemize}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
Skipped / Load cell reader shows the applied 37.5 KN {{Tension}⁠~}force
and LabView displays the voltage being applied.
...
{\footnotesize
If the actuator has back-driven for 60 kN (2x the max load) tension
force, slowly apply a {Compression}⁠~ force of 37.5 kN (1.25x the max
load) with the the load actuator.\\
Otherwise, \textbf{go to step 15}.~\\[2\baselineskip]
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Test Data \\
 {\footnotesize
\textbf{Note:~}In order to apply a {Compression}⁠ ~force of 37.5 kN:
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
Skipped / Load cell reader shows the applied 37.5 KN
{{Compression}⁠~}force and LabView displays the voltage being applied.
...
If the motor encoder position has changed significantly
(\textgreater{}10 counts or 0.36 deg of motor rotation), the actuator
has back-driven.~~\\[2\baselineskip]
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
{Tension}⁠ force fully removed. Load cell reader and Load graph in the
LabView showing zero load.\\[2\baselineskip]
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
{Compression}⁠ force fully removed. Load cell reader and Load graph in
the LabView showing zero load.\\[2\baselineskip]
...
\end{tabular}
 Description \\
{\footnotesize
View the ~force vs displacement plot in the Labview.\\[2\baselineskip]
...
\end{tabular}
 Description \\
{\footnotesize
Apply a 20kN tension load by using the LabView function to increase the
air supply value of \textasciitilde{}2.25V to one of the pneumatic
valve.
...
\tightlist
\item
  Set pneumatic valve (closest to hexapod actuator side) to 2.25V (0-10
  Vdc) while the other valve remains at 0V.
\item
  increase air supply using LabVIEW function~
\end{itemize}
...
\end{tabular}
 Description \\
{\footnotesize
Apply a 20kN compression load by using the LabView function to increase
the air supply value of \textasciitilde{}2.25V to one of the pneumatic
valve.
...
\tightlist
\item
  Set pneumatic valve (away from hexapod actuator side) to 2.25V (0-10
  Vdc) while the other valve remains at 0V.
\item
  increase air supply using LabVIEW function~
\end{itemize}
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Expected Result \\
{\footnotesize
The actuator does not dissipate more than 10W of heat.
