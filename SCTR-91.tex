...
in the ‚Negative Limit‚~(unmodified) sheet of the
\emph{Stiffness Test Results Modified vs Unmodified.xlsx~}document, the
starting position measured by the external encoders were as follows:
...
\begin{tabular}{p{2cm}p{14cm}}
\toprule
Step 1.10 & Step Execution Status: \textbf{ Pass } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
Command the actuator to move to the absolute positions of +500um, 0um,
...
\begin{tabular}{p{2cm}p{14cm}}
\toprule
Step 1.11 & Step Execution Status: \textbf{ Pass } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
...
\begin{tabular}{p{2cm}p{14cm}}
\toprule
Step 1.12 & Step Execution Status: \textbf{ Not Executed } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
Close all the Labview VI files.
...
\begin{tabular}{p{2cm}p{14cm}}
\toprule
Step 2.10 & Step Execution Status: \textbf{ Pass } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
Command the actuator to move to the absolute positions of +500um, 0um,
...
\begin{tabular}{p{2cm}p{14cm}}
\toprule
Step 2.11 & Step Execution Status: \textbf{ Pass } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
Record the results from all three sets of tests.
...
\begin{tabular}{p{2cm}p{14cm}}
\toprule
Step 2.12 & Step Execution Status: \textbf{ Not Executed } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
Close all the Labview VI files.
...
\end{tabular}
 Description \\
{\footnotesize
Apply a {15kN compression}⁠ load by using the LabView function to apply the
appropriate voltage values to the compression and tension air valves.
...
\begin{tabular}{p{2cm}p{14cm}}
\toprule
Step 3.10 & Step Execution Status: \textbf{ Pass } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
Command the actuator to move to the absolute positions of +500um, 0um,
...
\begin{tabular}{p{2cm}p{14cm}}
\toprule
Step 3.11 & Step Execution Status: \textbf{ Pass } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
Record the results from all three sets of tests.
...
\begin{tabular}{p{2cm}p{14cm}}
\toprule
Step 3.12 & Step Execution Status: \textbf{ Not Executed } \\ \hline
\end{tabular}
 Description \\
{\footnotesize
Close all the Labview VI files.
...
\hdashrule[0.5ex]{\textwidth}{1pt}{3mm}
  Actual Result \\
{\footnotesize
The tension force was applied by setting Channel 0 = 2.19V
